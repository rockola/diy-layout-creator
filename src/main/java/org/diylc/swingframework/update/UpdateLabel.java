...
public class UpdateLabel extends JLabel {
	...
	addMouseListener(new MouseAdapter() {
		...
		public void mouseClicked(MouseEvent e) {
			...
			new UpdateDialog(UpdateLabel.this,
	...
	SwingWorker<List<Version>, Void> worker =
	    new SwingWorker<List<Version>, Void>() {
		...
		protected void done() {
			...
			setIcon(Icon.LightBulbOff.icon());
			setToolTipText("Error occurred while searching for updates: "
				       + e.getMessage());
