...
/**
  ...
  change events. Property name is "dragPoint" and x, y coordinates are
  stored as oldValue and newValue respectively. <br> <br> Note to
  self: try to come up with something more elegant.
