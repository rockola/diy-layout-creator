...
public class Ruler extends JComponent {
  ...
  /**
   * Changes cursor position. If less than zero, indication will not be rendered. For horizontal
  ...
  protected void paintComponent(Graphics g) {
    if (bufferImage == null) createBufferImage();
    ...
    if (selectionRect != null) {
      ...
      if (orientation == HORIZONTAL) {
        bufferGraphics.drawLine(
            (int) selectionRect.getX(), 0, (int) selectionRect.getX(), SIZE - 1);
        bufferGraphics.drawLine(
            (int) (selectionRect.getX() + selectionRect.getWidth()),
            0,
            (int) (selectionRect.getX() + selectionRect.getWidth()),
            SIZE - 1);
      } else {
        bufferGraphics.drawLine(
            0, (int) selectionRect.getY(), SIZE - 1, (int) selectionRect.getY());
        bufferGraphics.drawLine(
            0,
