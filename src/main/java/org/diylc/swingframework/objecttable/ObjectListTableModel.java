...
public class ObjectListTableModel<T> extends AbstractTableModel {
  ...
  /**
   * Creates a model based on the specified <code>dataClass</code> and <code>field</code>. Each
   * field may have on of the following syntax forms: <br>
   *
   * <ul>
   *   <li><b>getterName</b> - creates a read only field which reads values using the specified
   *       getter
   *   <li><b>getterName/setterName</b> - creates an editable field which uses getter to read and
   *       setter to write value
   *   <li><b>action:actionName</b> - creates an action column with the specified name
   * </ul>
   *
   * @param dataClass
   * @param fields
