...
public @interface ComponentDescriptor {
   ...
   *     CreationMethod.POINT_BY_POINT</code> is used, user will have to select ending points before
  ...
  /**
   * @return if the component can be rotated and/or mirrored, returns a class of the transformer
   *     that can do it
   */
