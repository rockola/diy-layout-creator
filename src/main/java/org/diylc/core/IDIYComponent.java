...
/**
   ...
   with {@link EditableProperty}.</li>
   <li>Component configuration should be stored int <code>public
   static</code> fields so they can be set through config file.</li>
   </ul>

   @author Branislav Stojkovic

   @param <T> type of component values, e.g. Resistance for resistors
   or String for transistors.
*/
public interface IDIYComponent<T> extends Serializable {
    ...
    /**
     * @return number of control points for this component
     *         instance. May vary between two instances of the same
     *         type, e.g. DIL IC with 8 and 16 pins will have 8 or 16
     *         pins although they are of the same type.
     */
    ...
    /**
     * @param index
     * @return true, if the specified control point may stick to
     *         control points of other components.
     */
    ...
    /**
     * @param pointIndex
     * @return name of the common point that joins all the other
     * points with the same name together, e.g. GND
     */
     ...
     * depend on component state, i.e. it should be treated as a
     * static method.
     *
     * @param g2d
     * @param width
