...
public abstract class AbstractGuitarPickup extends AbstractTransparentComponent<String> {
  ...
  protected void drawMainLabel(
    ...
    if (orientation == Orientation._90) g2d.rotate(Math.PI / 2);
    ...
    StringUtils.drawCenteredText(
        g2d, getName(), 0, 0, HorizontalAlignment.CENTER, VerticalAlignment.CENTER);
  ...
  public Polarity getPolarity() {
    if (polarity == null) polarity = Polarity.North;
    return polarity;
  }
