...
public class DialogFactory {
  ...
  public PropertyEditorDialog createPropertyEditorDialog(
      List<PropertyWrapper> properties, String title, boolean saveDefaults) {
  ...
  public File[] showOpenMultiDialog(
      FileFilter fileFilter,
      File initialFile,
      String defaultExtension,
      IFileChooserAccessory accessory,
    ...
    JFileChooser openFileChooser = new JFileChooser();
    initializeFileChooser(
        openFileChooser, fileFilter, initialFile, defaultExtension, accessory, true);
  ...
  public File showSaveDialog(
    ...
    initializeFileChooser(
        saveFileChooser, fileFilter, initialFile, defaultExtension, accessory, false);
  ...
  private File processFileChooserResult(
      int result, JFileChooser fileChooser, String defaultExtension) {
  ...
  private File[] processFileMultiChooserResult(
      int result, JFileChooser fileChooser, String defaultExtension) {
    fileChooser.setAccessory(null);
    if (result == JFileChooser.APPROVE_OPTION) {
      lastDirectory = fileChooser.getCurrentDirectory();
  ...
  public AboutDialog createAboutDialog(
      String appName, Icon icon, String version, String author, URL url, String htmlContent) {
    AboutDialog dialog =
        new AboutDialog(mainFrame, appName, icon, version, author, url, htmlContent);
    return dialog;
  }
  ...
  public UploadDialog createUploadDialog(
      JFrame ownerFrame, IPlugInPort plugInPort, String[] categories, boolean isUpdate) {
  ...
  public ProgressDialog createProgressDialog(
      String title, String[] buttonCaptions, String description, boolean useProgress) {
    ProgressDialog dialog =
        new ProgressDialog(mainFrame, title, buttonCaptions, description, useProgress);
    return dialog;
  }
}
