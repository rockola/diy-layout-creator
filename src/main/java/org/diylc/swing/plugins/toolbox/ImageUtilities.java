...
public final class ImageUtilities {
	...
	ColorModel model = ImageUtilities.colorModel(// 3 // MAGIC NUMBER! //ola 20200107
	...
	ColorModel model;
	try {
	    model = GraphicsEnvironment.getLocalGraphicsEnvironment()
	...
	static Image createDisabledImage(Image img) {
	    FilteredImageSource prod = new FilteredImageSource(img.getSource(),
							       DISABLED_BUTTON_FILTER);
	...
	public ToolTipImage(String toolTipText, ColorModel cm,
