...
public class JarScanner {
   ...
   * @param recursive if true, scanner will go in depth and scan all sub-folders.
   * @return
   */
  ...
  /**
   * Loads all JAR files from the specifier folder and tries to find and load classes from those
   * JARs that implement specified interface.
   *
   * @param folderName
   * @param packageName
   * @param baseInterface
